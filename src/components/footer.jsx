export default function Footer() {
  return (
    <>
      <footer className="px-4 py-8 dark:bg-zinc-900 dark:text-zinc-400">
        <div className="container flex flex-wrap items-center justify-center mx-auto space-y-4 sm:space-y-0">
          <div className="flex flex-row pr-3 space-x-4 sm:space-x-8">
            <ul className="flex flex-wrap items-center space-x-4 sm:space-x-8">
              ...
              <div className="flex items-center justify-center flex-shrink-0 w-12 h-12 rounded-full dark:bg-amber-400">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 512 512"
                  fill="currentColor"
                  className="w-8 h-8 rounded-full dark:text-zinc-900"
                >
